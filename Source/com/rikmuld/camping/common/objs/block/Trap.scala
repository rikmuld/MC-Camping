...
class Trap(infoClass: Class[_]) extends BlockMain(infoClass, Objs.tab, ModInfo.MOD_ID, Material.iron, false, false) with BlockWithModel with BlockWithInstability {
