...
public class ContainerTrap extends ContainerMain{
	...
	{
		this.trap = (TileEntityBearTrap) tile;

		this.addSlotToContainer(new SlotItem(tile, 0, 80, 12));
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int slotNum)
	{
		...
		if(slot!=null&&slot.getHasStack())
		{
			...
			{
				if(!mergeItemStack(itemstack1, trap.getSizeInventory(), inventorySlots.size(), true))
				{
					return null;
				}
			}
