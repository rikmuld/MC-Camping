...
public class ItemKnife extends ItemMain implements IKnife {
	...
	public ItemKnife(String name)
	{
		super(name);
		setHasSubtypes(true);
		setMaxDamage(ConfigInfoInteger.value(ConfigInfo.TOOL_DAMAGE));
		setMaxStackSize(1);
	}
	...
	public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player)
	{
		...
		if((stack.getItemDamage() < this.getMaxDamage()) && !world.isRemote)
		{
			...
			int[] ids = new int[]{Block.stairsBrick.blockID, Block.stairsCobblestone.blockID, Block.stairsNetherBrick.blockID, Block.stairsNetherQuartz.blockID, Block.stairsSandStone.blockID, Block.stairsWoodBirch.blockID, Block.stairsWoodJungle.blockID, Block.stairsWoodOak.blockID, Block.stairsWoodSpruce.blockID, Block.chest.blockID, Block.chestTrapped.blockID, Block.wood.blockID, Block.pumpkin.blockID, Block.pumpkinLantern.blockID, Block.dispenser.blockID, Block.dropper.blockID, Block.pistonBase.blockID, Block.pistonStickyBase.blockID, Block.enderChest.blockID, Block.anvil.blockID, Block.signPost.blockID, Block.redstoneComparatorIdle.blockID, Block.redstoneComparatorActive.blockID, Block.redstoneRepeaterIdle.blockID, Block.redstoneRepeaterActive.blockID, Block.furnaceIdle.blockID, Block.furnaceBurning.blockID, Block.fenceGate.blockID};
			...
			for(int i: ids)
			{
				if(world.getBlockId(x, y, z) == i)
				{
					...
					else if((i == Block.fenceGate.blockID) || (i == Block.redstoneRepeaterActive.blockID) || (i == Block.redstoneRepeaterIdle.blockID) || (i == Block.redstoneComparatorActive.blockID) || (i == Block.redstoneComparatorIdle.blockID))
					{
						int meta = world.getBlockMetadata(x, y, z);

						if((meta == 3) || ((meta % 4) == 3))
						{
							world.setBlockMetadataWithNotify(x, y, z, meta - 3, 2);
						}
						else
						{
							world.setBlockMetadataWithNotify(x, y, z, meta + 1, 2);
