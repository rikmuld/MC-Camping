...
public class BlockFlowerHemp extends BlockFlowerMain {
	...
	{
		if((world.getBlockId(x, y - 1, z) == blockID) && (world.getBlockMetadata(x, y - 1, z) == 4) && (world.getBlockMetadata(x, y, z) == 5)) return true;
		else
		{
			if((world.getBlockId(x + 1, y - 1, z) == Block.waterStill.blockID) || (world.getBlockId(x - 1, y - 1, z) == Block.waterStill.blockID) || (world.getBlockId(x, y - 1, z + 1) == Block.waterStill.blockID) || (world.getBlockId(x, y - 1, z - 1) == Block.waterStill.blockID))
			{
	...
	{
		if((metadata == 5) && (world.getBlockId(x, y - 1, z) == blockID) && (world.getBlockMetadata(x, y - 1, z) == 4))
		{
	...
	public void onNeighborBlockChange(World world, int x, int y, int z, int neighborId)
	{
		...
		{
			if((world.getBlockMetadata(x, y + 1, z) != 5) || (world.getBlockId(x, y + 1, z) != blockID))
			{
