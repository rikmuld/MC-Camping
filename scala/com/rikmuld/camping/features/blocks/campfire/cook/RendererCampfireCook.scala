...
import com.rikmuld.camping.features.blocks.campfire.cook.RendererCampfireCook._
...
class RendererCampfireCook extends TileEntitySpecialRenderer[TileEntityCampfireCook] {
  override def render(tile: TileEntityCampfireCook, x: Double, y: Double, z: Double,
  ...
  //TODO simplify
  def renderCoalPiece(piece: Int, tile: TileEntityCampfireCook,
