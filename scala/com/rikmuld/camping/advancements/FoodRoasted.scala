...
object FoodRoasted {
  class Trigger extends AdvancementTrigger[(ItemStack, ItemStack), Instance] {
  ...
  protected class Instance(in: Option[ItemPredicate],
                           out: Option[ItemPredicate]) extends TriggerInstance[(ItemStack, ItemStack)](FOOD_ROASTED) {
