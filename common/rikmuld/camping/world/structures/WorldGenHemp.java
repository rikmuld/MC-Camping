	...
	public boolean generate(World world, Random random, int x, int y, int z)
	{
		for(int l = 0; l<20; ++l)
		{
			...
			if(world.isAirBlock(i1, y, k1)
					&&(world.getBlockMaterial(i1-1, y-1, k1)==Material.water||world.getBlockMaterial(i1+1, y-1, k1)==Material.water||world.getBlockMaterial(i1, y-1, k1-1)==Material.water||world
							.getBlockMaterial(i1, y-1, k1+1)==Material.water))
			{
