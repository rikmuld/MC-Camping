...
public class TileEntitySleepingBagRenderer extends TileEntitySpecialRenderer{
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float f)
	{
		...
		if(tile.worldObj.getBlockMetadata(tile.xCoord, tile.yCoord, tile.zCoord)==0)bindTexture(new ResourceLocation(TextureInfo.MODEL_SLEEPING_TOP));
		else bindTexture(new ResourceLocation(TextureInfo.MODEL_SLEEPING_DOWN));
